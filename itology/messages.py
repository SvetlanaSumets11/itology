...
INVITATION_MESSAGE = "Welcome to ITology - your assistant in the IT field!.\n\nYou have subscribed to the " \
                     "'{project}' project. The service has created a convenient workspace for project participants " \
                     "in the Trello service - an assistant for organizing team work by using lists with tasks, " \
                     "labels, calendars and other Trello features.\n\nA board has been created, all project " \
                     "participants have been added, so we invite you to visit it:\n{link}."

SUBJECT_DEVELOPMENT_NOTIFICATION = 'Start of the project'
