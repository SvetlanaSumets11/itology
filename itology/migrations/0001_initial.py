...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='client',
            name='roles',
            field=models.ManyToManyField(help_text='The role of an expert in a project', related_name='client', to='itology.role', verbose_name='roles'),
        ),
        migrations.AddField(
            model_name='client',
            name='user',
        ...
        migrations.AddField(
            model_name='advert',
            name='comment',
            field=models.ForeignKey(help_text='Advert comment', on_delete=django.db.models.deletion.CASCADE, related_name='advert', to='itology.comment', verbose_name='comment'),
        ),
        migrations.AddField(
            model_name='advert',
            name='creator',
